...
def load_data(config, tokenize):
    ...
    dataset = {
        ...
        "entity2id": entity2id, # entity到ID的映射
        "relation2id": relation2id, # relation到ID的映射
        "word2id": word2id, # 对文本数据的词语编号
        "num_word": num_word, # 
        "rel_texts": relation_texts, # relation文本的描述，便于更好理解语义
        "rel_texts_inv": relation_texts_inv, # 逆关系的描述
        "ent_texts": entities_texts # 实体的描述文本
    }
    return dataset
